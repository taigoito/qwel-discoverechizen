            ...
            <section>
                ...
                <div class="grid">
                  <div class="grid__inner">
                    <div class="grid__4 order__2">
                      <img src="<?php echo DE_THEME_URI . '/assets/stay/stay_mangetu.jpg'; ?>">
                    </div>
              ...
              <section>
                ...
                <div class="grid">
                  <div class="grid__inner">
                    <div class="grid__4 order__2">
                      <img src="<?php echo DE_THEME_URI . '/assets/stay/stay_shirahamaso.jpg'; ?>">
                    </div>
                    <div class="grid__6 order__1">
                      <h4>INFORMATION</h4>
                      <table class="table">
              ...
              <section>
                ...
                <div class="grid">
                  <div class="grid__inner">
                    <div class="grid__4 order__2">
                      <img src="<?php echo DE_THEME_URI . '/assets/stay/stay_takasusou.jpg'; ?>">
                    </div>
                    <div class="grid__6 order__1">
                      <h4>INFORMATION</h4>
                      <table class="table">
              ...
              <section>
                ...
                <div class="grid">
                  <div class="grid__inner">
                    <div class="grid__4 order__2">
                      <img src="<?php echo DE_THEME_URI . '/assets/stay/stay_ishimaru.jpg'; ?>">
                    </div>
                    <div class="grid__6 order__1">
                      <h4>INFORMATION</h4>
                      <table class="table">
              ...
              <section>
                ...
                <div class="grid">
                  <div class="grid__inner">
                    <div class="grid__4 order__2">
                      <img src="<?php echo DE_THEME_URI . '/assets/stay/stay_kane8.jpg'; ?>">
                    </div>
                    <div class="grid__6 order__1">
                      <h4>INFORMATION</h4>
                      <table class="table">
              ...
              <section>
                ...
                <div class="grid">
                  <div class="grid__inner">
                    <div class="grid__4 order__2">
                      <img src="<?php echo DE_THEME_URI . '/assets/stay/stay_yoneya.jpg'; ?>">
                    </div>
                    <div class="grid__6 order__1">
                      <h4>INFORMATION</h4>
                      <table class="table">
              ...
              <section>
                ...
                <div class="grid">
                  <div class="grid__inner">
                    <div class="grid__4 order__2">
                      <img src="<?php echo DE_THEME_URI . '/assets/stay/stay_cafeearth_app.jpg'; ?>">
                    </div>
                    <div class="grid__6 order__1">
                      <h4>INFORMATION</h4>
                      <table class="table">
