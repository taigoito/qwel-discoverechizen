      ...
      <div class="row">
        <div id="footer-content-1">
          ...
          <ul id="footer-social-btns">
            <li><a href="https://www.instagram.com/echizen_moriagetai/" target="_blank"><img src="<?php echo get_template_directory_uri() . '/assets/svg/icon_instagram.svg'; ?>"></a></li>
            <li><a href="https://www.facebook.com/e.moriagetai" target="_blank"><img src="<?php echo get_template_directory_uri() . '/assets/svg/icon_facebook.svg'; ?>"></a></li>
