  ...
  <?php
    ...
    <div class="main__wrapper">
      <div class="main__container">
        ...
        /**
         * 固定コンテンツ
         * .lp.--schoolExcursion を使う (sass/objects/projects/_landingPages.scss)
         */
        ?>
        <article class="lp --schoolExcursion">
          ...
          <div id="lpNav">
            <ul class="lp__nav --mb_2">
              ...
              <li class="lp__navItem --local"><a href="#"><img src="<?php echo DE_THEME_URI . '/assets/studytour/heading_covid.svg'; ?>" alt="COVID-19対策"></a></li>
            ...
            <div class="grid --top --mb_3">
              <div class="grid__inner">
                ...
                <div class="grid__item lp__content --goToPDF">
                  ...
                  <a href="#"><img src="<?php echo DE_THEME_URI . '/assets/studytour/btn_pdf.svg'; ?>" alt="利用料金・概要についてはこちら"></a>
                </div>
              </div>
            </div>
            ...
            <div class="grid --mb_3">
              <div class="grid__inner">
                ...
                <div class="grid__6 --p_0">
                  ...
                  <p class="--text_right"><a href="#">エリアマップはこちら</a></p>
                </div>
              </div>
            </div>
            ...
            <div class="grid --top --expand --mb_3">
              <div class="grid__inner">
                ...
                <div class="grid__12 --mt_3 --mb_3 --text_center">
                  <a class="lp__btn --reservation">コンシェルジュに問い合わせ<span data-icon="ei-chevron-right"></span></a>
                </div>
              </div>
            </div>
          </section><!-- #reservation -->
